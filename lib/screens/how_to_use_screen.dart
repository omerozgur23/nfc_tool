    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          //   const Spacer(flex: 2)
          // ]),
          buildListTile("howToUseScreen.newText1".tr()),
          buildListTile("howToUseScreen.newText2".tr()),
          buildListTile("howToUseScreen.newText3".tr()),
          buildListTile("howToUseScreen.newText3".tr()),
          buildButton(
              context: context,
          ...
          buildListTile("howToUseScreen.editText1".tr()),
          buildListTile("howToUseScreen.editText2".tr()),
          buildListTile("howToUseScreen.editText3".tr()),
          buildListTile("howToUseScreen.editText4".tr()),
          buildListTile("howToUseScreen.editText5".tr()),
          buildButton(
              context: context,
              buttonText: "homeScreen.databaseButton",
              onPressed: () {},
              icon: CupertinoIcons.layers_alt),
          buildListTile("howToUseScreen.databaseText1".tr()),
          buildListTile("howToUseScreen.databaseText2".tr()),
          buildButton(
              context: context,
              buttonText: "homeScreen.deleteButton",
              onPressed: () {},
              icon: CupertinoIcons.delete),
          buildListTile("howToUseScreen.deleteText1".tr()),
          buildListTile("howToUseScreen.deleteText2".tr()),
          buildListTile("howToUseScreen.deleteText3".tr()),
          buildButton(
              context: context,
              buttonText: "homeScreen.wifiButton",
              onPressed: () {},
              icon: CupertinoIcons.wifi),
          buildListTile("howToUseScreen.wifiText1".tr()),
          buildListTile("howToUseScreen.wifiText2".tr()),
          buildListTile("howToUseScreen.wifiText3".tr()),
          buildListTile("howToUseScreen.wifiText4".tr()),
          buildButton(
              context: context,
